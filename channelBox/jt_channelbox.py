...
class UI():
	...
	def __init__(self):
		...
		self.colorDict = {'green': [.5, 1, .5], 'greenCyan': [.25, 1, .75], 'cyan': [0, 1, 1],
		...
		self.channelPane = 'MayaWindow|MainChannelsLayersLayout|ChannelsLayersPaneLayout'
	...
	def defaultSettings(self, *args):
		...
		cmds.timeControl('MayaWindow|toolBar6|MainTimeSliderLayout|formLayout9|frameLayout2|timeControl1', e=True,
